...
9. If using genAI to create code specify the language version, and read the code for bugs before commiting it 
...
![Image generated by Dr. Candace Makeda Moore prompting [Adobe Firefly](https://www.adobe.com/products/firefly.html).](fig/chest_xay.png){alt='Misled image'}
